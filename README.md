...
| `VENICE_INFERENCE_KEY` | For deeper Horizon insights | Your Venice.ai Inference Key (add some credit for reliable usage). Must be server-side only (no NEXT_PUBLIC_). |
